...
import com.stripe.android.AlipayAuthenticationHandler
...
class AlipayActivity : StripeIntentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.fakeButton.setOnClickListener {
            confirmWithSdk(object : AlipayAuthenticationHandler {
    ...
    private fun confirmWithSdk(authenticator: AlipayAuthenticationHandler) {
